...
private:
	...
	void DrawTriangle(const glm::vec3& pnt0 , const glm::vec3& pnt1, const glm::vec3& pnt2, const glm::vec3& faceMiddle, const glm::vec3& color, const Camera& camera,float zfar, bool gray, const Scene& scene, const Material& material, glm::vec3 faceNormal, std::vector<glm::vec3> pointsNormals);
	...
	glm::vec3 Illuminate(glm::vec3 p1, glm::vec3 p2, glm::vec3 p3, glm::vec3 pnt, glm::vec3 faceMiddle, const LightSource& lightSource, const Material& matriel, glm::vec3 faceNormal, std::vector<glm::vec3> pointsNormals, const Camera& camera);
