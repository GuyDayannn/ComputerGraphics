...
private:
	...
	void DrawTriangle(const glm::vec3& pnt0, const glm::vec3& pnt1, const glm::vec3& pnt2, const glm::vec3& color, const Camera& camera,float zfar, bool gray, const Scene& scene, const Material& material, glm::vec3 faceNormal, std::vector<std::vector<glm::vec3>> fverticesNormals);
	...
	glm::vec3 Illuminate(glm::vec3 pnt, const LightSource& lightSource, const Material& matriel, glm::vec3 faceNormal, std::vector<std::vector<glm::vec3>> fverticesNormals, const Camera& camera);
